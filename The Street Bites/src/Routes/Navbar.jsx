...
const Navbar = () => {
    ...
    return (
        <div className="navbar" style={{ display: 'flex', backgroundColor: "#121618", justifyContent: 'space-between' }}>
          ...
          <div style={{ width: "30%", display: "flex", alignItems: 'center', justifyContent: 'space-around',marginRight:"15%" }}>

            <NavLink className="link" activeStyle={{ color: 'yellow' }} to="/">Home</NavLink>
            <NavLink className="link" activeStyle={{color:"red"}} to="/menu">Menu</NavLink>
